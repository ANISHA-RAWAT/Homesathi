...
class ReviewAdmin(admin.ModelAdmin):
    # ── correct field names matching the new Review model ──
    list_display    = ('reviewer', 'related_property', 'property_rating', 'owner_rating', 'is_approved', 'created_at')
    list_filter     = ('is_approved', 'property_rating', 'owner_rating')
    search_fields   = ('reviewer__email', 'reviewer__full_name', 'related_property__title', 'comment')
